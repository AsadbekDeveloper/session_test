...
// in session_test/test/mocks.dart.
...
import 'package:session_test/data/models/session_model.dart' as _i4;
import 'package:session_test/data/repositories/session_repository.dart' as _i2;
...
class MockSessionRepository extends _i1.Mock implements _i2.SessionRepository {
  ...
  @override
  _i3.Future<List<_i4.Session>> getSessions() =>
      (super.noSuchMethod(
